        ...
        >
          ...
          <div className="md:hidden">
            <div className="flex">
              ...
              <a
                href="tel:0780579261"
                className="flex-1 bg-red-600 py-3 px-2 text-center relative"
              >
                ...
                <div className="text-white/80 text-[10px] relative z-10">
                  24/7 Emergency
                </div>
              </a>
            ...
            <div className="relative h-24 flex">
              ...
              <div className="flex-1 bg-red-600 flex items-center justify-center relative z-20">
                ...
                >
                  ...
                  <div className="text-white/80 text-sm">24/7 Emergency</div>
                </a>
                {/* Angled edges */}
