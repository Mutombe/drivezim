...
const StoryPage = () => {
  ...
  const milestones = [
    {
      year: "2019",
      title: "Founded",
      desc: "Drive Zimbabwe was established with a clear mission: to promote care, courtesy, and concentration on our roads.",
      icon: "🚀",
    },
    {
      year: "2020",
      title: "Perseverance",
      desc: "Continued serving Zimbabweans through challenging times, committed to being there when needed most.",
      icon: "📈",
    },
    {
      year: "2022",
      title: "Expansion",
      desc: "Extended our coverage across major cities and highways, bringing reliable assistance to more communities.",
      icon: "🗺️",
    },
    {
      year: "2024",
      title: "Innovation",
      desc: "Launched membership programs to better serve our growing customer base.",
      icon: "💡",
    },
  ];
  ...
  const teamRoles = [
    { title: "Experienced Operator", desc: "Expert ready to diagnose and fix" },
    {
      ...
      desc: "Always on call to coordinate your rescue",
    },
    {
      title: "Recovery Expertise",
      desc: "Trained for the most challenging situations",
    },
  ...
  const whyChooseUs = [
    {
      ...
      desc: "Quick arrival when you need help most",
      icon: "⚡",
    },
    {
      title: "Transparent Pricing",
      desc: "No hidden fees - you know exactly what you're paying before we start",
      icon: "💎",
    },
    {
      title: "Professional Service",
      desc: "Trained and experienced to handle your vehicle with care",
      icon: "👨‍🔧",
    },
    {
      title: "Wide Coverage",
      desc: "Serving Harare and surrounding areas, plus long-distance assistance",
      icon: "🗺️",
    },
    {
      title: "Quality Equipment",
      desc: "Well-maintained tow truck with recovery capabilities",
      icon: "🚛",
    },
    {
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-center py-20 md:py-0">
            ...
            >
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-3xl mx-auto px-4 mb-6 md:mb-8">
                Founded in 2019 with a clear purpose: to promote care, courtesy,
                and concentration on Zimbabwe's roads—values that continue to
            ...
            >
              ...
              <div className="space-y-4 md:space-y-6 text-gray-300">
                <p className="text-sm md:text-base lg:text-lg leading-relaxed">
                  Drive Zimbabwe Roadside Assistance was founded in 2019 with a
                  clear purpose: to promote{" "}
                  <span className="text-red-400 font-semibold">
                    care, courtesy, and concentration
                  </span>{" "}
                  on our roads—values that continue to shape everything we do
                  today.
                </p>
                <p className="text-sm md:text-base lg:text-lg leading-relaxed">
                  What started as a small operation with a dedicated team has
                  grown into Zimbabwe's trusted roadside assistance provider. We
                  deliver{" "}
                  <span className="text-red-400 font-semibold">
                    quality, reliable, and cost-effective
                  </span>{" "}
                  services, helping thousands of stranded motorists get back on
                  the road safely.
                </p>
                <p className="text-sm md:text-base lg:text-lg leading-relaxed">
                  Our commitment to excellence remains unchanged. Every day, we
                  work tirelessly to ensure that when you're stranded on the
                  road, help is just a phone call away.
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {coreValues.map((value, i) => (
              ...
              >
                ...
                {/* Gradient Overlay */}
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${value.gradient} opacity-90`}
                />
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            >
              ...
              <div className="absolute bottom-4 md:bottom-8 left-4 md:left-8 right-4 md:right-8">
                ...
                <p className="text-gray-200 text-sm md:text-base">
                  Experienced and dedicated to helping you
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm md:text-lg text-gray-300 mb-6 md:mb-8 leading-relaxed">
                Experienced, trained, and ready to assist you 24/7. We embody
                our values of care, courtesy, and concentration in everything we
                do.
              </p>
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-3xl lg:text-4xl text-white font-medium mb-4 md:mb-6 leading-relaxed px-4">
              "We don't just tow vehicles—we rescue people from stressful
              situations and get them safely back on the road."
            </p>
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          ...
          >
            ...
            <p className="text-sm md:text-xl text-gray-300 mb-4 px-2">
              Join thousands of satisfied customers who trust Drive Zimbabwe for
              their roadside needs
            </p>
